    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16">
      ...
      <section className="relative text-center mb-[25vh]">
        ...
        <FadeIn delay={0.3} direction="up">
          <h1 className="font-serif text-5xl md:text-7xl font-bold tracking-tight text-white z-10 relative">
            Adam Goad
          </h1>
        </FadeIn>
        ...
        <FadeIn delay={0.5} direction="up">
          <p className="max-w-3xl mx-auto mt-6 text-base sm:text-lg md:text-xl font-sans font-bold text-white leading-relaxed z-10 relative drop-shadow-md">
