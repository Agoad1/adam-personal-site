  ...
  return (
    <div className="card space-y-3">
      <div className="flex items-center justify-between">
        ...
        <span className="font-mono text-2xl font-bold text-slate-900">{pct.toFixed(0)}%</span>
      </div>
      ...
      {remaining > 0 ? (
        ...
        <p className="font-serif text-xs text-blue-600 font-semibold">Goal reached!</p>
      )}
    </div>
  )
}
